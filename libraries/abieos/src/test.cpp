...
void check_types() {
    ...
    check_type(context, 0, "symbol_code", R"("VEX")");
    ...
    check_type(context, 0, "symbol", R"("4,VEX")");
    ...
    check_type(context, 0, "asset", R"("1.2345 VEX")");
    check_type(context, 0, "asset", R"("-1.2345 VEX")");
    ...
    check_type(context, token, "transfer",
               R"({"from":"useraaaaaaaa","to":"useraaaaaaab","quantity":"0.0001 VEX","memo":"test memo"})");
    check_type(
    ...
    check_type( //
        ...
        R"({"to":"useraaaaaaab","memo":"test memo","from":"useraaaaaaaa","quantity":"0.0001 VEX"})",
        R"({"from":"useraaaaaaaa","to":"useraaaaaaab","quantity":"0.0001 VEX","memo":"test memo"})", false);
    check_type(
        context, 0, "transaction",
