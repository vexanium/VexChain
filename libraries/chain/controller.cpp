...
#define SET_APP_HANDLER( receiver, contract, action) \
   ...
   SET_APP_HANDLER( vexcore, vexcore, newaccount );
   SET_APP_HANDLER( vexcore, vexcore, setcode );
   SET_APP_HANDLER( vexcore, vexcore, setabi );
   SET_APP_HANDLER( vexcore, vexcore, updateauth );
   SET_APP_HANDLER( vexcore, vexcore, deleteauth );
   SET_APP_HANDLER( vexcore, vexcore, linkauth );
   SET_APP_HANDLER( vexcore, vexcore, unlinkauth );
/*
...
*/
   ...
   SET_APP_HANDLER( vexcore, vexcore, canceldelay );
   }
