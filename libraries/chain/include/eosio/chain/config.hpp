...
const static name system_account_name    { "vexcore"_n };
const static name null_account_name      { "vex.null"_n };
const static name producers_account_name { "vex.prods"_n };
...
const static name eosio_auth_scope       { "vex.auth"_n };
const static name eosio_all_scope        { "vex.all"_n };

const static name active_name     { "active"_n };
const static name owner_name      { "owner"_n };
const static name eosio_any_name  { "vex.any"_n };
const static name eosio_code_name { "vex.code"_n };
