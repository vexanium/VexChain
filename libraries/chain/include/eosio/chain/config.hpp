...
const static uint64_t system_account_name    = N(vexcore);
const static uint64_t null_account_name      = N(vex.null);
const static uint64_t producers_account_name = N(vex.prods);
...
const static uint64_t eosio_auth_scope       = N(vex.auth);
const static uint64_t eosio_all_scope        = N(vex.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(vex.any);
const static uint64_t eosio_code_name = N(vex.code);
