...
try:
    ...
    # (automatically taken care by the automatically generated vexcore account)
    ...
    cmd = "create account -j vexcore sample EOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV\
    ...
    setProdsStr += ']}'
    cmd="push action -j vexcore setprods '{}' -p eosio".format(setProdsStr)
    trans = producerNode.processCleosCmd(cmd, cmd, silentErrors=False)
    assert trans
