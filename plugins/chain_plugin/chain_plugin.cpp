...
read_only::get_account_results read_only::get_account( const get_account_params& params )const {
   ...
   if( abi_serializer::to_abi(code_account.abi, abi) ) {
      ...
      const auto token_code = "vex.token"_n;
...
chain::symbol read_only::extract_core_symbol()const {
   ...
   // The following code makes assumptions about the contract deployed on vexcore account (i.e. the system contract) and how it stores its data.
   get_primary_key<detail::ram_market_exchange_state_t>("vexcore"_n, "vexcore"_n, "rammarket"_n, eosio::chain::string_to_symbol_c(4,"RAMCORE"),
