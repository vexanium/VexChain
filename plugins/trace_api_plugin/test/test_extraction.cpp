...
namespace {
   ...
   auto make_transfer_action( chain::name from, chain::name to, chain::asset quantity, std::string memo ) {
      return chain::action( std::vector<chain::permission_level> {{from, chain::config::active_name}},
                            "vex.token"_n, "transfer"_n, make_transfer_data( from, to, quantity, std::move(memo) ) );
   }
...
BOOST_AUTO_TEST_SUITE(block_extraction)
   ...
   {
      auto act1 = make_transfer_action( "alice"_n, "bob"_n, "0.0001 VEX"_t, "Memo!" );
      auto act2 = make_transfer_action( "alice"_n, "bob"_n, "0.0001 VEX"_t, "Memo!" );
      auto act3 = make_transfer_action( "alice"_n, "bob"_n, "0.0001 VEX"_t, "Memo!" );
      auto actt1 = make_action_trace( 0, act1, "vex.token"_n );
      ...
      const std::vector<action_trace_v1> expected_action_traces {
         {
            {
               0,
               "vex.token"_n, "vex.token"_n, "transfer"_n,
               {{"alice"_n, "active"_n}},
               make_transfer_data("alice"_n, "bob"_n, "0.0001 VEX"_t, "Memo!")
            },
            {}
         },
         {
            {
               1,
               "alice"_n, "vex.token"_n, "transfer"_n,
               {{"alice"_n, "active"_n}},
               make_transfer_data("alice"_n, "bob"_n, "0.0001 VEX"_t, "Memo!")
            },
            {}
         },
         {
            {
               2,
               "bob"_n, "vex.token"_n, "transfer"_n,
               {{"alice"_n, "active"_n}},
               make_transfer_data("alice"_n, "bob"_n, "0.0001 VEX"_t, "Memo!")
            },
            {}
   ...
   BOOST_FIXTURE_TEST_CASE(basic_multi_transaction_block, extraction_test_fixture) {
      auto act1 = make_transfer_action( "alice"_n, "bob"_n, "0.0001 VEX"_t, "Memo!" );
      auto act2 = make_transfer_action( "bob"_n, "alice"_n, "0.0001 VEX"_t, "Memo!" );
      auto act3 = make_transfer_action( "fred"_n, "bob"_n, "0.0001 VEX"_t, "Memo!" );
      auto actt1 = make_action_trace( 0, act1, "vex.token"_n );
         ...
         {
            {
               ...
               "bob"_n, "vex.token"_n, "transfer"_n,
               {{ "bob"_n, "active"_n }},
               make_transfer_data( "bob"_n, "alice"_n, "0.0001 VEX"_t, "Memo!" )
            },
            {}
         }
      };
      ...
      const std::vector<action_trace_v1> expected_action_trace3 {
         {
            {
               2,
               "fred"_n, "vex.token"_n, "transfer"_n,
               {{ "fred"_n, "active"_n }},
               make_transfer_data( "fred"_n, "bob"_n, "0.0001 VEX"_t, "Memo!" )
            },
            {}
         }
      };
   ...
   BOOST_FIXTURE_TEST_CASE(onerror_transaction_block, extraction_test_fixture)
   {
      ...
      auto actt1 = make_action_trace( 0, onerror_act, "vex.token"_n );
      ...
      const std::vector<action_trace_v1> expected_action_trace {
         {
            {
               0,
               "vex.token"_n, "vexcore"_n, "onerror"_n,
               {{ "alice"_n, "active"_n }},
