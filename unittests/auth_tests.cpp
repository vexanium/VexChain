...
BOOST_AUTO_TEST_CASE(link_auths) { try {
   ...
   // Link authority for vexcorereqauth action with alice's spending key
   chain.link_authority(name("alice"), name("vexcore"), name("spending"), name("reqauth"));
   ...
   BOOST_CHECK_THROW( chain.link_authority(name("alice"), name("vexcore"), name("spending"), name("reqauth")), action_validate_exception);

   // Unlink alice with vexcorereqauth
   chain.unlink_authority(name("alice"), name("vexcore"), name("reqauth"));
   ...
   // Link authority for any vexcoreaction with alice's scud key
   chain.link_authority(name("alice"), name("vexcore"), name("scud"));
...
BOOST_AUTO_TEST_CASE(link_then_update_auth) { try {
   ...
   chain.link_authority(name("alice"), name("vexcore"), name("first"), name("reqauth"));
...
BOOST_AUTO_TEST_CASE( any_auth ) { try {
   ...
   chain.link_authority( name("alice"), name("vexcore"), name("vex.any"), name("reqauth") );
   chain.link_authority( name("bob"), name("vexcore"), name("vex.any"), name("reqauth") );
